...
const Dashboard = () => {
  ...
  // console.log("Data", discription, status, date);
//   const Data = [];
...
//       date: date
//     })
//     const commentsJsonified = JSON.stringify(Data);
//     localStorage.setItem('Data', commentsJsonified);
//     handleClose();
//   }
...
//   const data_is = JSON.parse(get_date)
  ...
  handleClick();
      ...
      <div style={{ background: "rgb(211 201 196)" }}>
        <div className="top_bar">
          ...
          >
            <input placeholder="Search your quary" />
            <button
              style={{
...
{/* user image and name */}
      ...
      <div style={{ marginTop: "" , borderRight:"2px solid black", margin:"50px 20px 5px 20px" }}>
        <img
      ...
      <h3><b>Website Devlopment Tracker</b></h3>
      </div>
